...
Alice = (0, 109790246752332785586117900442206937983841168568097606235725839233151034058387)
Bob = (0, 45290526009220141417047094490842138744068991614521518736097631206718264930032)
encrypted_flag = {'iv': '31068e75b880bece9686243fa4dc67d0', 'encrypted_flag': 'e2ef82f2cde7d44e9f9810b34acc885891dad8118c1d9a07801639be0629b186dc8a192529703b2c947c20c4fe5ff2c8'}
A = curve.decompress(Alice)
B = curve.decompress(Bob)
print(A)
print(B)
G = curve.decompress((x0bit, y0))
base_point = curve.base_point
print(base_point)
na = 22177185339821817642584340290303072361216253354374422848549320419774574392697
shared_secret = gen_shared_secret(curve, na, Bob)
key = sha1(str(shared_secret).encode('ascii')).digest()[:16]
